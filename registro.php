...
<section id="login">
    ...
    <div class="wrap-title-section">
        <h2>Conviértete en un miembro de AMIRA-DG</h2>
        <hr>
    </div>

    <div class="col-md-4" style = "display: flex; flex-flow: column; margin: 0 auto;">
    <?php 
    ...
    <div class="col-md-4 mx-auto" id="login" style = "">

        <h4 class="text-dark text-center">¡IMPORTANTE, para tener en cuenta!</h4>

        <div class="alert alert-warning" role="alert">
            <p>Es muy importante que la información que digites sea información real, esto porque nos ayudará a facilitar y garantizar la seguridad de tu cuenta y la recuperación de ella en caso de pérdida. De lo contrario será muy difícil ayudarte</p>
        </div>

        <form action="administrador/Logica/validacionRegistro.php" method="POST">

        <!-- USUARIO -->
            <div class="form-group">

                <label for="usuario" class="col-sm-8 col-form-label col-form-label-sm"><h4>Documento de identidad</h4></label>

                <input type="number" class="form-control border-success" style="height: 4rem; border-radius: 1rem; font-size: 1.2rem;" placeholder="Número de identificación" name="usuario" id="usuario" autocomplete="off" required autofocus> 
        ...
        <!-- NOMBRES Y APELLIDOS -->
            <div class="form-group">
                ...
                <label for="nombre" class="col-sm-6 col-form-label col-form-label-sm"><h4>Nombres y Apellidos</h4></label>

                <input type="text" class="form-control border-success transformacion1" style="height: 4rem; border-radius: 1rem; font-size: 1.2rem;" placeholder="Ej: José Carlos Martinez Perea" name="nombre" id="nombre" autocomplete="off" required> 
        ...
        <!-- CORREO ELECTRONICO -->
            <div class="form-group">
                ...
                <label for="correo" class="col-sm-6 col-form-label col-form-label-sm"><h4>Correo electronico</h4></label>

                <input type="email" class="form-control border-success" style="height: 4rem; border-radius: 1rem; font-size: 1.2rem;" placeholder="Ej: josemartinez@misena.edu.co" name="correo" id="correo" autocomplete="off" required> 
       ...
       <!-- CONFIRMAR CONTRASEÑA -->
        ...
        <!-- INGRESAR -->
            <div class="form-group" style = "margin-top: 2rem;">
                    ...
                    <input class="btn btn-dark btn-block" type="submit" name="enviar" value="Registrarme" style="height: 4rem; border-radius: 1rem; font-size: 2rem; font-weight: bold; font-family: 'Grave Nuts', cursive;" >
