        ...
        <div class="wrap-nav-header">
            <nav class="nav-header">
                ...
                <ul class="main-menu">
                    ...
                    <li class="menu-item"><a href="../index.php#nosotros">Nosotros</a></li>
    ...
    <div class="col-md-4" id="login" style = "display: flex; flex-flow: column; margin: 0 auto;">
        ...
        <!-- USUARIO -->
            <div class="form-group">
                ...
                <input type="number" class="form-control border-success" style="height: 4rem; border-radius: 1rem; font-size: 1.2rem;" placeholder="Digita el número de tu documento de identificación" name="usuario" id="usuario" autocomplete="off" required autofocus> 
        ...
        <!-- CORREO ELECTRONICO -->
            <div class="form-group">
                ...
                <input type="email" class="form-control border-success" style="height: 4rem; border-radius: 1rem; font-size: 1.2rem;" placeholder="Digita tu correo electronico" name="correo" id="correo" autocomplete="off" required> 
        ...
        <div class="form-group">
            ...
            <label for="idRegistro" class="col-sm-6 col-form-label col-form-label-sm"><h4>ID de registro</h4></label>

            <input type="number" class="form-control border-success" style="height: 4rem; border-radius: 1rem; font-size: 1.2rem;" placeholder="Digita el ID que se te proporcionó al registrarte" name="idRegistro" id="idRegistro" autocomplete="off" required> 
        ...
        <!-- INGRESAR -->
            <div class="form-group" style = "margin-top: 2rem;">
                    ...
                    <input class="btn btn-dark btn-block" type="submit" name="enviar" value="Validar información" style="height: 4rem; border-radius: 1rem; font-size: 2rem; font-weight: bold; font-family: 'Grave Nuts', cursive;" >
...
<footer class="footer">
    ...
    <div class="wrap-footer">
        ...
        <div class="text-element-footer element-footer">
            ...
            <li><a href="../index.php#nosotros">Equipo</a></li>
