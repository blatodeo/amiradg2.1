    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            ?>
                ...
                <?php
                $cuenta  = "SELECT COUNT(usuario) AS resultados FROM user_login WHERE rol = 2";# Acción
                $rcuenta = mysqli_query($conn, $cuenta);# Resultado de la acción
                ...
                <div class="row" style="margin-top: 2rem; margin-left: 2rem; margin-right: 2rem;">
                    ...
                    <div class="col-md-4 d-flex align-items-center">
                        ...
                        <div class="form-group">
                            ...
                            <h3>Aprendices (<span class="text-success"><?php echo $row['resultados'] ?></span>)</h3>
                ...
                if(isset($_POST['buscar'])){# Verifico si hay una variable y no es NULL
                    ...
                    $resultados  = "SELECT COUNT(nombre) AS resultados FROM user_login WHERE nombre LIKE '%$buscar%' AND rol = 2";# Acción
                    ...
                    ?>
                        <div class="col-md-12 mx-auto text-center" style="margin-top: 2rem;">
                            <h5>Resultados encontrados para <span class="text-success"><?php echo $buscar ?></span> 
                                ...
                                <a name="" id="" class="btn btn-light" href="lista.php" style="margin-left: 4rem;">
                        ...
                        <div class="col-md-10 mx-auto">
                            <table class="table table-light">
                                ...
                                <tbody>      
                                    <?php 
                                    #APRENDICES
                                    $query  = "SELECT user_login.*, descripcion FROM user_login INNER JOIN rol_user ON rol=rol_user.id WHERE nombre LIKE '%$buscar%' AND rol=2";# Acción
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Convertir en ADMIN">
                                                <a  href="update_rol.php?id=<?php echo $row['id']?>" class="btn btn-success" name="update">
                    ...
                    <?php
                        ...
                        <div class="col-md-12 text-center" style="margin-top: 2rem;">
                            <h3 style="text-align: center; ">
                                ...
                                <a name="" id="" class="btn btn-light" href="lista.php">
                                    <i class="fa fa-close"></i>
                                </a>
                            </h3>
                        ...
                        <div class="col-md-3 mx-auto" style="margin-top: 2rem;">
                            ...
                            <div class="card border-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <a name="" id="" class="btn btn-success btn-lg" href="lista2.php">Ver aquí los Administradores</a>
                        ...
                        <div class="col-md-8 mx-auto" style="margin-top: 2rem;">
                            ...
                            <table class="table table-light">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                    $query  = "SELECT user_login.*, descripcion FROM user_login INNER JOIN rol_user ON rol=rol_user.id WHERE rol=2";
