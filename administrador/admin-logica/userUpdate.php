<?php
    ...
    if (isset($_GET['id'])){# Verifico si existe una variable y no es NULL
        ...
        if(strlen($_FILES['foto']['tmp_name'])>0){# Verifico que se haya seleccionado un archivo, SI se seleccionó guardo su contenido
            ...
            if ($tamañoImagen>40000000){

                $_SESSION['message'] = '¡Error al guardar cambios, La imagen seleccionada supera el limite de capacidad, por favor seleccione otra y vuelva a intentarlo!';# Mensaje
                $_SESSION['message_type'] = 'danger'; # Tipo de mensaje
                header('Location:../admin.php');# Redirección
