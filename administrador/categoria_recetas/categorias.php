...
<html lang="en">
    ...
    <body>
        ...
        ?>
                ...
                $cuenta  = "SELECT COUNT(descripcion) AS resultados FROM categoria_recetas";/* utilizo una variable para traer la información */
                ...
                <?php
                if(isset($_POST['buscar'])){#SI presiona buscar, muestra los resultados que coinicidan con la busqueda

                    $buscar      = $_POST['encontrar'];
                    $resultados  = "SELECT COUNT(descripcion) AS resultados FROM categoria_recetas WHERE descripcion LIKE '%$buscar%'";#Acción
                                ...
                                <div class="col-md-8 mx-auto">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php 
                                            ...
                                            $query  = "SELECT * FROM categoria_recetas  WHERE descripcion LIKE '%$buscar%' ORDER BY descripcion ASC";/* Traigo la información */
                                            $result = mysqli_query($conn, $query);/* Almaceno la información */

                                            while($dataCategoria = mysqli_fetch_array($result)){ /* Muestro la información por medio de arrays */

                                        ?>
                                            <tr>

                                                <td><?php echo $dataCategoria['id']?>          </td>
                                                <td class="transformacion1"><?php echo $dataCategoria['descripcion']?> </td>
                                                <td>
                ...
                }else{#SINO, muestro todas las categorias
                ?>
                        ...
                        <div class="col-md-8 mx-auto">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <?php 
                                    ...
                                    $query = "SELECT * FROM categoria_recetas ORDER BY id";/* Traigo la información */
                                    $result = mysqli_query($conn, $query);/* Almaceno la información */

                                    while($resultCategoria = mysqli_fetch_array($result)){ /* Muestro la información por medio de arrays */

                                ?>
                                    <tr>

                                        <td><?php echo $resultCategoria['id']?>          </td>
                                        <td class="transformacion1"><?php echo $resultCategoria['descripcion']?> </td>
                                        <td>
