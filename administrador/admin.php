            ...
            <div class="border-end bg-success" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="dropdown">
                        ...
                        <button class="list-group-item list-group-item-action text-white bg-success p-3 h5 dropdown-toggle" type="button" id="recetasOptions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <h5>
                        <a class="list-group-item list-group-item-action bg-success border-0 text-white p-3" href="aprendices/lista.php">
            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-success bg-success border-bottom">
                    ...
                    <div class="container-fluid">
                        ...
                        <h4 class="transformacion1 text-white" style="position: absolute;
                        left: 100px;"><?php echo $row['nombre'] ?></h4>
                ...
                <?php } unset($_SESSION['message']); ?>
                    ...
                    <div class="row col-md-12" style="margin: 3%;">
                        ...
                        <div class="col-md-8 card border-success border-right-0">
                            ...
                            <form action="admin-logica/userUpdate.php?id=<?php echo $row['id'] ?>" method="POST" enctype = "multipart/form-data">
                            ...
                            <!-- NOMBRE -->
                                <div class="form-group row" style="margin: 1rem;">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control form-user" type="text" name="nombre" id="nombre" placeholder="Nombre de usuario..." value="<?php echo $row['nombre'] ?>">
                                    </div>
                            ...
                            <!-- NOMBRE -->
                                <div class="form-group row" style="margin: 1rem;">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control form-user" type="email" name="correo" id="correo" placeholder="Correo electronico..." value="<?php echo $row['correo'] ?>">
                                    </div>
