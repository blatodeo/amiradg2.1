                                ...
                                <table class="table bordered-none">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="transformacion1"><?php echo $row['descripcionunidad']; ?> </td>
                                            <td>
                                                <form action="productos/quitar.php?id=<?php echo $row['id']?>" method="post">
                                                    <input type="hidden" name="id" value="<?php echo $id ?>">
                                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Quitar">
                                                    <button type="submit" name="quitar" class="btn btn-danger btn-lg" style="border-radius: 1rem;">
